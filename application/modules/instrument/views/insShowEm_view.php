    ...
    <div class="content" id="main-page-content "> 
      ...
      <div class="panel panel-default">
        <div class="panel-heading clearfix">
          ...
          <a href="formPrice" class="btn btn-info pull-right">แก้ไขราคาอุปกรณ์</a> 
        </div>
          ...
          <tbody>
            <tr>
             ...
             <div class="btn-group text-center">
                <a href="Instrument/formUpdate/?id=<?php echo $key->IdIns; ?>" class="btn btn-xs btn-warning" data-toggle="tooltip" title="แก้ไข">
