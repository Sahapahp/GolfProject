...
<form action="/action_page.php" >
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form" name="FName" required>
   </div>

   <div class="form-group">
    <label for="text">นามสกุล :</label>
    <input type="text" class="form" name="LName" required>
   </div>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form" name="IdCard" OnKeyPress="return chkNumber(this)" required maxlength="13">
  </div>

   <div class="form-group">
    <label for="text">ที่อยู่ :</label>
    <input type="textarea" class="form" name="address" required>
  </div>
   ...
   <div class="form-group">
    ...
    <input type="text" class="form" name="phone" OnKeyPress="return chkNumber(this)" required maxlength="10">
  </div>
